...
python main.py --lr 0.001 --timepoints R1 R2 R3 R4 R5 R6 --data_path "$DATA_PATH"
...
#python main.py --lr 0.001 --timepoints R1 R2 R3 R5 R6 --data_path "$DATA_PATH"
#python main.py --lr 0.001 --timepoints R1 R2 R3 R4 R6 --data_path "$DATA_PATH"
#python main.py --lr 0.001 --timepoints R1 R2 R3 R4 R5 --data_path "$DATA_PATH"
