...
python main.py --lr 0.001 --lr_patience 20 --weight_decay 1e-3 --timepoints R1 R2 R3 R4 R5 R6 --data_path "$DATA_PATH"
#python main.py --lr 0.001 --lr_patience 25 --timepoints R2 R3 R4 R5 R6  --data_path "$DATA_PATH"
